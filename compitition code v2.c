...
void pre_auton()
{
	...
	while(nLCDButtons != centerButton)
	{
		...
		case 3:
			...
			{
				waitForRelease();
				count++; // <------------- might have to change the "++" to "--"    --------------------->
			}
			break;
